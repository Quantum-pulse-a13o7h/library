...
export default function Home() {
  ...
  // Featured books - just take first 3 for now
    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <section className="py-12 bg-white border-b border-border/40">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: BookOpen, label: "Curated Books", value: "1,000+" },
              ...
              >
                ...
                <p className="text-muted-foreground font-medium uppercase tracking-wide text-xs">{stat.label}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-12">
          <div>
            <h2 className="text-3xl sm:text-4xl font-display font-bold text-foreground mb-2">Featured Reads</h2>
            <p className="text-muted-foreground">Handpicked selections for this month</p>
          </div>
          <Link href="/catalog">
