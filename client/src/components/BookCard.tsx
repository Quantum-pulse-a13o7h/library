...
import { Book as BookIcon, Users, CheckCircle, XCircle } from "lucide-react";
    ...
    >
      <div className="relative aspect-[2/3] overflow-hidden bg-muted">
        ...
        <div className="absolute top-2 right-2">
          {isAvailable ? (
            <span className="bg-emerald-500/90 backdrop-blur-sm text-white text-xs font-bold px-2 py-1 rounded-full shadow-sm flex items-center gap-1">
              <CheckCircle className="w-3 h-3" /> Available
            </span>
          ) : (
            <span className="bg-rose-500/90 backdrop-blur-sm text-white text-xs font-bold px-2 py-1 rounded-full shadow-sm flex items-center gap-1">
      ...
      <div className="p-5 flex flex-col flex-grow">
        <div className="mb-auto">
          ...
          <h3 className="text-lg font-display font-bold leading-tight mb-1 text-foreground">
            {book.title}
          </h3>
        ...
        <div className="mt-4 pt-4 border-t border-border/50 flex items-center justify-between">
          <div className="text-xs text-muted-foreground flex flex-col">
            <span className="font-medium">{book.availableQuantity} of {book.totalQuantity} left</span>
          ...
          <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle className="font-display text-2xl">Borrow "{book.title}"</DialogTitle>
              </DialogHeader>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 py-4">
                  ...
                  <div className="flex justify-end gap-2 pt-4">
                    ...
                    <Button type="submit" disabled={createLoan.isPending}>
                      {createLoan.isPending ? "Confirming..." : "Confirm Loan"}
                    </Button>
                  </div>
                </form>
              </Form>
